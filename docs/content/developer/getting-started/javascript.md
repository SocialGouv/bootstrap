...
layout: docs
title: JavaScript
description: Bring Social Gouv Bootstrap to life with our optional JavaScript plugins. Learn about each plugin, our data and programmatic API options, and more.
