...
layout: docs
title: Contents
description: Discover what's included in Social Gouv Bootstrap, including our precompiled and source code flavors.
...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="text-warning" href="{{< param "bootstrapDocBaseurl" >}}/layout/grid">Only grid system</a></td>
      <td class="bg-light text-muted">Not included</td>
      <td class="bg-light text-muted">Not included</td>
      <td><a class="text-warning" href="{{< param "bootstrapDocBaseurl" >}}/utilities/flex">Only flex utilities</a></td>
    </tr>
    <tr>
      <th scope="row">
      ...
      <td class="bg-light text-muted">Not included</td>
      <td><a class="text-warning" href="{{< param "bootstrapDocBaseurl" >}}/content/reboot">Only Reboot</a></td>
      <td class="bg-light text-muted">Not included</td>
      <td class="bg-light text-muted">Not included</td>
    </tr>
  </tbody>
